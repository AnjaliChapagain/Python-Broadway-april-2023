...
print(student["roll_number"]) # This raises KeyError because 'roll_number' is not a key dictionary student
...
print(roll_number) # This gives None. If the key not present in the dictionary is provided
# to get() method then it returns None
...
name = student.get("name, "Jane") # Here Jane is the default value
print(name)  Result--Jon

# Adding and updating dictionary
student = {"name": "Jon", "age": 45, "department": "CS"}
student["roll"] = 4
int(student) # result => {"name": "Jon", "age":45, "department":"CS", "roll":4
...
# 3. A tuple can also be a dictionary key because it is immutable type.
#But, if it contains mutable type, then it can't be used as a key
